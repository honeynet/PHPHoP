...
<title>Horde :: DataTree Browser</title>
...
<li><a href="/mail/admin/datatree.php?Horde=5ac6c1690a91622c7489c5c40a5dbc5d" onmouseout="window.status=\'\';" onmouseover="window.status=\'DataTree\'; return true;" class="current"><img src="/mail/themes/graphics/perms.png" alt="DataTree" title="DataTree" /><br />DataTree</a></li>
...
<div class="header" style="margin:8px 0">DataTree Browser</div>
<p class="notice"><img src="/mail/themes/graphics/alerts/message.png" alt="Message" title="Message" />&nbsp;&nbsp;not supported</p><br class="spacer" /><script language="JavaScript1.5" type="text/javascript">
<!--
var _setHordeTitle = 1;
try {
    if (parent.frames.horde_main) parent.document.title = \'Horde :: DataTree Browser\';
} catch (e) {
}
// -->
</script>
...
<!--
if (typeof(_setHordeTitle) == \'undefined\' && parent.frames.horde_main) parent.document.title = \'Horde :: DataTree Browser\';
// -->
</script>
</body>
</html>';
