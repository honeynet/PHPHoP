...
<li><a href="/mail/admin/user.php?Horde=5ac6c1690a91622c7489c5c40a5dbc5d" onmouseout="window.status=\'\';" onmouseover="window.status=\'Users\'; return true;" class="current"><img src="/mail/themes/graphics/user.png" alt="Users" title="Users" /><br />Users</a></li>
...
<div class="header" style="margin:8px 0">User Administration</div>
<table border="0" cellspacing="0" cellpadding="2" width="100%">
<tr>
  <td align="left" class="header">
    <b>Adding users is disabled.</b>
  </td>
</tr>
<tr>
  <td align="left" class="control">
    Your authentication backend does not support adding users, or the feature has been disabled for some other reason.  </td>
</tr>
</table>
<br />
<table border="0" cellspacing="0" cellpadding="2" width="100%">
<tr>
  <td align="left" class="header">
    <b>Listing users is disabled.</b>
  </td>
</tr>
<tr>
  <td align="left" class="control">
    Your authentication backend does not support listing users, or the feature has been disabled for some other reason.  </td>
</tr>
</table>
...
try {
    if (parent.frames.horde_main) parent.document.title = \'Horde :: User Administration\';
} catch (e) {
}
// -->
</script>
...
<!--
if (typeof(_setHordeTitle) == \'undefined\' && parent.frames.horde_main) parent.document.title = \'Horde :: User Administration\';
// -->
</script>
</body>
</html>';
