...
<title>Horde :: Permissions Administration</title>
...
<li><a href="/mail/admin/perms/index.php?Horde=5ac6c1690a91622c7489c5c40a5dbc5d" onmouseout="window.status=\'\';" onmouseover="window.status=\'Permissions\'; return true;" class="current"><img src="/mail/themes/graphics/perms.png" alt="Permissions" title="Permissions" /><br />Permissions</a></li>
...
<div class="header" style="margin:8px 0">Permissions Administration</div>
<div class="item0"><div style="float:left;width:50%;">&nbsp;</div></div><script language="JavaScript1.5" type="text/javascript">
<!--
var _setHordeTitle = 1;
try {
    if (parent.frames.horde_main) parent.document.title = \'Horde :: Permissions Administration\';
} catch (e) {
}
// -->
</script>
...
<!--
if (typeof(_setHordeTitle) == \'undefined\' && parent.frames.horde_main) parent.document.title = \'Horde :: Permissions Administration\';
// -->
</script>
</body>
</html>';
